...
3. Use the generated profiles to assess each dataset for suitability, completeness, (perceived) quality, and consistency. In general, the more complete and consistent the dataset, the better the linkages between resources, the ultimate goal of linked data architectures. Example criteria include:
